...
{
		[KeyInfo("ID")]
		public class V_Chances :ModelBase
		{
			...
			public System.String ChanCreateManName {get; set;}
			public System.String ChanDueManName {get; set;}
			public System.String ChanStateText {get; set;}
		}
}
